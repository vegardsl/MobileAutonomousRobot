...
void settingUpdateCallback(const std_msgs::Char::ConstPtr& msg)
{
  ...
  else if(msg->data == 'n' || msg->data == 'N')
  {
    key_command_pub.publish(msg);
  }
...
int main(int argc, char **argv)
{
  ...
  ros::Publisher cmd_vel = n.advertise<geometry_msgs::Twist>("cmd_vel_loc", 1);
  key_command_pub = n.advertise<std_msgs::Char>("switch_setting", 1);
